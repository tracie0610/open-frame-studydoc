...
var data='&agt='+escape(agt)+'&r='+escape(document.referrer)+'&aN='+escape(navigator.appName)+'&lg='+escape(navigator.systemLanguage)+'&OS='+escape(navigator.platform)+'&aV='+escape(navigator.appVersion)+'&ntime=0.55923600 1222151698';
var cnzz_a=gc_cnzz("cnzz_a496487");
...
document.write('<script src="http://222.77.187.23/online.php?id=496487&online=1&show=line" charset="gb2312"></script>');
document.write('<img src="http://222.77.187.23/stat.htm?id=496487'+data+'" border=0 width=0 height=0>');
var et=(86400-ed.getHours()*3600-ed.getMinutes()*60-ed.getSeconds());
ed.setTime(now+1000*(et-ed.getTimezoneOffset()*60));
document.cookie="cnzz_a496487="+cnzz_a+";expires="+ed.toGMTString()+ "; path=/";
...
document.write('<img src="http://js.cnzz.com/sc.php?id=496487" border=0 width=0 height=0>');
