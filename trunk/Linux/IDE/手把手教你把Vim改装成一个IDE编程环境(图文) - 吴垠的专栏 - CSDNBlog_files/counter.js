...
function cnt_readCookie(name)
{
  ...
  return cookieValue;
	...
	switch(s_host)
	{
		...
		case "live.csdn.net": 
		case "sd.csdn.net": 
		case "testing.csdn.net": 
		case "gamedev.csdn.net": 
		case "mobile.csdn.net": 
		case "chuang.csdn.net": 
		case "java.csdn.net": 
		case "safe.csdn.net": 
		case "itpro.csdn.net": 
		case "database.csdn.net": 
		case "dotnet.csdn.net": 
		case "cio.csdn.net": 
		case "webdev.csdn.net": 
		case "soa.csdn.net": 
		case "forumim.csdn.net": 
		case "topic.csdn.net": 
		case "community.csdn.net": 
		case "forum.csdn.net":
		case "middleware.csdn.net": 
		case "bpm.csdn.net": 
		case "hi.csdn.net": 
		case "profile.csdn.net": 
		case "miniblog.csdn.net": 
		case "vote.csdn.net":  
		case "blog.csdn.net": 
		case "writeblog.csdn.net": 
	...
	if(s_host.indexOf("hi.csdn.net")!=-1 )
	{
		disxn=1;
	}
	if(s_host.indexOf("download.csdn.net")!=-1 )
	{
		disxn=1;
	}	
	if(disxn==1)
	{
  document.write('<script src="http://www.csdn.net/xnim/imfunction_utf8.js" type="text/javascript"><'+'/script>');
	}
