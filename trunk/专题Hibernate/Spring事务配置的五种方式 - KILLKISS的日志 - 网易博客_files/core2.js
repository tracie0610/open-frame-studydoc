...
ihtml+='<textarea id="plainEditor'+this.parentId+'" style="overflow-y:auto;border:none;padding:2px;font-size:14px;line-height:135%;'+widthStr+'height:'+this.options.height+'px;" '+disabledStr+'></textarea></div>'
...
if(this.curWindow&&event.keyCode==Event.KEY_ESC){
