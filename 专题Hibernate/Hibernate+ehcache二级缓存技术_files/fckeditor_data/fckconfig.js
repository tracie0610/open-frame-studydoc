...
FCKConfig.ToolbarSets["Default"] = [
	['HighLighter','Source','DocProps','-','NewPage','Preview','-','Templates'],
...
FCKConfig.ToolbarSets["Basic"] = [
	['HighLighter','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','FontSize','TextColor','BGColor','-','RemoveFormat','Image']
] ;
