...
var advEdtCrt=UD.visitorRank<0?null:this._createAdvanceEditor.bind(this);
...
if(!this._bStatusNoRight){
if(this.htmleditor!=null&&this.htmleditor.hasSwitched){
...
_oCodeDiv.innerHTML=
'<label for="txtVC">验证码:&nbsp;</label><input type="text" class="bd01 g_f_focus g_c_input" value="" maxlength="4" id="valcode'+sParentId+'" />'+
...
reply:function(sComId,bLogin,sName,vPara,sReplyToUserId){
var sContent=$("comContent"+sComId).innerHTML;
var s=[];
s.push('<blockquote class="selitm bd01">');
if(bLogin){
s.push('<a class="c05" href="http://'+vPara+'/" target="_blank">'+sName+'</a><span class="c05 dot">：</span><br>');
}else{
...
Element.scrollTo(this._sCmPubElemId);
...
sObjName:this._oOptions.sObjName+".htmleditor",fnAfterLoad:_afterLoadAdvanceEditor});
this._initEditor();
