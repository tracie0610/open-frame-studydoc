...
function StranText(txt,value)
{
	setCookie(JF_cn,value);
...
if (true)
{
	...
	var value = getCookie(JF_cn);
	if(value && value != '') {
		try { Default_isFT = parseInt(value); } catch(e) {}
		document.body.innerHTML = StranText(document.body.innerHTML,Default_isFT);
	}
}